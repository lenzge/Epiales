...
# Player is in Idle state when he doesn't do something actively and isn't
# influenced by environment

# Play short animations depending on the last state, before playing idle animation automatically
func enter(_msg := {}):
